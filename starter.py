...
# Determine if the letter grade of the given variable 'score'. If the variable is a 90
# or above, console-log an 'A', between 80 and 89, console-log a 'B', between 70 
#and 79, 'C', between 60 and 69, 'D', and anything below 60 should console-log an 
#'F'.
if score >= 90:
    print "A"
elif score >= 80:
...
# Problem 13
# Print out the total amount of elements in the `friends` array. The Python 
#method you are looking for is similar to the JavaScript property `.length`.
...
friends.insert(2, 'Nathan')

print(friends)

# Problem 15
# Remove the last item in the array (try to think about how you can do this 
#dynamically, meaning, if the array contents were to change, your code would 
#still work).
